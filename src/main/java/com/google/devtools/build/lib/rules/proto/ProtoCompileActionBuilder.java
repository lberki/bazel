...
public class ProtoCompileActionBuilder {
  ...
  private static void addIncludeMapArguments(
      String outputDirectory,
    ...
    commandLine.addAll(
        VectorArg.of(transitiveImports).mapped(new ExpandImportArgsFn(
            outputDirectory, directProtoSourceRoots)));
